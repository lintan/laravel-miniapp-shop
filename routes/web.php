...
Route::prefix('sms')->group(function () {
    Route::get('password/sms', 'Auth\ForgotPasswordController@showSendSmsForm')
        ->name('sms.password.sms'); //显示填写手机号表单
    Route::post('password/check', 'Auth\ForgotPasswordController@sendResetSms')
    ...
    Route::post('password/reset', 'Auth\ForgotPasswordController@smsResetPassword')
